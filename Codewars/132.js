Your coworker was supposed to write a simple helper function to 
capitalize a string (that contains a single word) before they went on 
vacation.
...
function capitalizeWord(word) {
    let repl = word.replace(word[0], word[0].toUpperCase())
    return repl;
  }
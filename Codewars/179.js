...
Warn the sheep in front of the wolf that it is about to be eaten. Remember
 that you are standing at the front of the queue which is at the end of 
 the array:
...
function warnTheSheep(queue) {
    let sheeps = queue.length - queue.indexOf("wolf") - 1;
    return (sheeps > 0) ? "Oi! Sheep number " + sheeps +"! You are about to be eaten by a wolf!" :
